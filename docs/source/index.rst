...
`POPCORN` is a program that uses singular value decomposition to do
...
If you download the repository, you can also install it in the popcorn
directory:
...
You can test it in this `notebook <https://github.com/pengchen1019/popcorn/blob/main/tests/test_popcorn.ipynb>`__
by yourself!
